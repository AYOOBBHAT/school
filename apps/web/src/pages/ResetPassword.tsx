...
function mapResetPasswordError(raw: string | undefined): string {
      ...
      <div className="max-w-md w-full">
        <div className="bg-white p-8 rounded-2xl shadow-2xl border border-gray-100">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-800 mb-2">Set Your New Password</h2>
          ...
          {success ? (
            ...
            <>
              {error ? (
                <div className="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-lg" role="alert" aria-live="assertive">
                  <div className="flex items-center">
                    <svg className="w-5 h-5 text-red-500 mr-2 shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden>
