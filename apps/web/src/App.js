...
export default function App() {
    ...
    void supabase;
    return (_jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Home, {}) }), _jsx(Route, { path: "/login", element: _jsx(Login, {}) }), _jsx(Route, { path: "/signup", element: _jsx(Signup, {}) }), _jsx(Route, { path: "/reset-password", element: _jsx(ResetPassword, {}) }), _jsx(Route, { path: "/forgot-password", element: _jsx(ForgotPassword, {}) }), _jsx(Route, { path: "/principal/dashboard", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/staff", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/classifications", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/classes", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/subjects", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/students", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/exams", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/salary", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/fees", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/clerk", element: _jsx(ClerkDashboard, {}) }), _jsx(Route, { path: "/clerk/fees", element: _jsx(ClerkDashboard, {}) }), _jsx(Route, { path: "/clerk/payments", element: _jsx(ClerkDashboard, {}) }), _jsx(Route, { path: "/clerk/marks", element: _jsx(ClerkDashboard, {}) }), _jsx(Route, { path: "/teacher/classes", element: _jsx(TeacherDashboard, {}) }), _jsx(Route, { path: "/teacher", element: _jsx(TeacherDashboard, {}) }), _jsx(Route, { path: "/student/home", element: _jsx(StudentDashboard, {}) }), _jsx(Route, { path: "/student", element: _jsx(StudentDashboard, {}) }), _jsx(Route, { path: "/parent", element: _jsx(Parent, {}) }), _jsx(Route, { path: "/admin/dashboard", element: _jsx(AdminDashboard, {}) }), _jsx(Route, { path: "/admin", element: _jsx(AdminDashboard, {}) })] }));
}
