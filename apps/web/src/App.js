...
function Navbar() {
    return (_jsx("nav", { className: "bg-white shadow-sm border-b", children: _jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "flex justify-between items-center h-16", children: [_jsx("div", { className: "flex items-center", children: _jsx("span", { className: "text-2xl font-bold text-blue-600", children: "SchoolSaaS" }) }), _jsxs("div", { className: "hidden md:flex space-x-8", children: [_jsx(Link, { to: "#features", className: "text-gray-700 hover:text-blue-600", children: "Features" }), _jsx(Link, { to: "#testimonials", className: "text-gray-700 hover:text-blue-600", children: "Testimonials" }), _jsx(Link, { to: "#faq", className: "text-gray-700 hover:text-blue-600", children: "FAQ" }), _jsx(Link, { to: "/login", className: "text-gray-700 hover:text-blue-600", children: "Login" }), _jsx(Link, { to: "/signup", className: "bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700", children: "Sign Up" })] })] }) }) }));
}
function Hero() {
    return (_jsx("section", { className: "bg-gradient-to-br from-blue-50 to-indigo-100 py-20", children: _jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "text-center", children: [_jsx("h1", { className: "text-5xl font-bold text-gray-900 mb-4", children: "All-In-One Cloud School Management System" }), _jsx("p", { className: "text-xl text-gray-600 mb-8 max-w-2xl mx-auto", children: "Manage attendance, fees, exams, reporting & more \u2014 in one place." }), _jsxs("div", { className: "flex gap-4 justify-center", children: [_jsx(Link, { to: "/signup", className: "bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition", children: "Start Free" }), _jsx(Link, { to: "#demo", className: "bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold border-2 border-blue-600 hover:bg-blue-50 transition", children: "Request Demo" })] }), _jsx("div", { className: "mt-12", children: _jsx("div", { className: "bg-white rounded-lg shadow-xl p-6 max-w-4xl mx-auto", children: _jsx("div", { className: "aspect-video bg-gray-200 rounded flex items-center justify-center text-gray-400", children: "Dashboard Screenshot Preview" }) }) })] }) }) }));
}
...
export default function App() {
    ...
    void supabase;
    return (_jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(Home, {}) }), _jsx(Route, { path: "/login", element: _jsx(Login, {}) }), _jsx(Route, { path: "/signup", element: _jsx(Signup, {}) }), _jsx(Route, { path: "/pending-approval", element: _jsx(PendingApproval, {}) }), _jsx(Route, { path: "/principal/dashboard", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/staff", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/classifications", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/classes", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/subjects", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/students", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/exams", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/salary", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/fees", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/principal/approvals", element: _jsx(PrincipalDashboard, {}) }), _jsx(Route, { path: "/clerk", element: _jsx(ClerkDashboard, {}) }), _jsx(Route, { path: "/clerk/fees", element: _jsx(ClerkDashboard, {}) }), _jsx(Route, { path: "/clerk/payments", element: _jsx(ClerkDashboard, {}) }), _jsx(Route, { path: "/clerk/marks", element: _jsx(ClerkDashboard, {}) }), _jsx(Route, { path: "/teacher/classes", element: _jsx(TeacherDashboard, {}) }), _jsx(Route, { path: "/teacher", element: _jsx(TeacherDashboard, {}) }), _jsx(Route, { path: "/student/home", element: _jsx(StudentDashboard, {}) }), _jsx(Route, { path: "/student", element: _jsx(StudentDashboard, {}) }), _jsx(Route, { path: "/parent", element: _jsx(Parent, {}) })] }));
}
