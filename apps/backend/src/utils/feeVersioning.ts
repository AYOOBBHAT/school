 ...
 */
export async function getClassFeeVersion(
  classGroupId: string,
 ...
 */
export async function getTransportFeeVersion(
  classGroupId: string,
 ...
 */
export async function hikeClassFee(
  schoolId: string,
  classGroupId: string,
  feeCategoryId: string,
  feeCycle: string,
 ...
 * Hike transport fee
 */
export async function hikeTransportFee(
  schoolId: string,
  classGroupId: string,
  routeName: string | null,
  feeCycle: string,
 ...
 */
export async function getFeeVersionForBillingMonth(
  classGroupId: string,
  feeCategoryId: string,
  feeCycle: string,
  billingMonth: Date, // First day of the billing month
  adminSupabase: any
): Promise<number> {
  // Get the version active for the first day of the billing month
  const version = await getClassFeeVersion(
    classGroupId,
    feeCategoryId,
    feeCycle,
    billingMonth,
